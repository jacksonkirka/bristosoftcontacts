...
class Ui_bristosoftContacts(object):
    ...
    def retranslateUi(self, bristosoftContacts):
        ...
        self.toolBar.setWindowTitle(_translate("bristosoftContacts", "Contacts", None))
        self.navToolBar.setWindowTitle(_translate("bristosoftContacts", "Navigation", None))
        self.groupToolBar.setWindowTitle(_translate("bristosoftContacts", "Groups", None))
