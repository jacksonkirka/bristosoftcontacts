...
class Ui_changepwdDialog(object):
    def setupUi(self, changepwdDialog):
        ...
        self.widget = QtGui.QWidget(self.passwordTab)
        self.widget.setGeometry(QtCore.QRect(1, 7, 391, 151))
        self.widget.setObjectName(_fromUtf8("widget"))
        self.gridLayout = QtGui.QGridLayout(self.widget)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.oldPasswordLabel = QtGui.QLabel(self.widget)
        ...
        self.oldPasswordLineEdit = QtGui.QLineEdit(self.widget)
        ...
        self.newPasswordLabel = QtGui.QLabel(self.widget)
        ...
        self.newPasswordLineEdit = QtGui.QLineEdit(self.widget)
        ...
        self.reenterPasswordLabel = QtGui.QLabel(self.widget)
        ...
        self.reenterPasswordLineEdit = QtGui.QLineEdit(self.widget)
