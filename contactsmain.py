...
class Ui_bristosoftContacts(object):
    def setupUi(self, bristosoftContacts):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/db_add.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNew.setIcon(icon2)
        self.actionNew.setObjectName(_fromUtf8("actionNew"))
        self.actionQuery = QtGui.QAction(bristosoftContacts)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/system-search-3.ico")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionQuery.setIcon(icon3)
        self.actionQuery.setObjectName(_fromUtf8("actionQuery"))
        self.actionQuit = QtGui.QAction(bristosoftContacts)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/system-shutdown-5.ico")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/network-connect.ico")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionDisconnect.setIcon(icon5)
        self.actionDisconnect.setObjectName(_fromUtf8("actionDisconnect"))
        self.actionFirst_Contact = QtGui.QAction(bristosoftContacts)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/media-skip-backward-6.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFirst_Contact.setIcon(icon6)
        self.actionFirst_Contact.setObjectName(_fromUtf8("actionFirst_Contact"))
        self.actionPrevious_Contact = QtGui.QAction(bristosoftContacts)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/media-seek-backward-4.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPrevious_Contact.setIcon(icon7)
        self.actionPrevious_Contact.setObjectName(_fromUtf8("actionPrevious_Contact"))
        self.actionNext_Contact = QtGui.QAction(bristosoftContacts)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/media-seek-forward-4.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNext_Contact.setIcon(icon8)
        self.actionNext_Contact.setAutoRepeat(True)
        self.actionNext_Contact.setObjectName(_fromUtf8("actionNext_Contact"))
        self.actionLast_Contact = QtGui.QAction(bristosoftContacts)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/media-skip-forward-4.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLast_Contact.setIcon(icon9)
        self.actionLast_Contact.setObjectName(_fromUtf8("actionLast_Contact"))
        self.actionSearch = QtGui.QAction(bristosoftContacts)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/system-search-4.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/db_update.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUpdate.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/edit-group.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Add_Group.setIcon(icon12)
        ...
        self.menuNav.addAction(self.actionFirst_Contact)
        self.menuNav.addAction(self.actionPrevious_Contact)
        self.menuNav.addAction(self.actionNext_Contact)
        self.menuNav.addAction(self.actionLast_Contact)
        ...
        self.navToolBar.addAction(self.actionFirst_Contact)
        self.navToolBar.addAction(self.actionPrevious_Contact)
        self.navToolBar.addAction(self.actionNext_Contact)
        self.navToolBar.addAction(self.actionLast_Contact)
    ...
    def retranslateUi(self, bristosoftContacts):
        ...
        self.actionFirst_Contact.setText(_translate("bristosoftContacts", "First Contact", None))
        self.actionFirst_Contact.setShortcut(_translate("bristosoftContacts", "Ctrl+Up", None))
        self.actionPrevious_Contact.setText(_translate("bristosoftContacts", "Previous Contact", None))
        self.actionPrevious_Contact.setShortcut(_translate("bristosoftContacts", "Ctrl+Shift+Left", None))
        self.actionNext_Contact.setText(_translate("bristosoftContacts", "Next Contact", None))
        self.actionNext_Contact.setShortcut(_translate("bristosoftContacts", "Ctrl+Shift+Right", None))
        self.actionLast_Contact.setText(_translate("bristosoftContacts", "Last Contact", None))
        self.actionLast_Contact.setShortcut(_translate("bristosoftContacts", "Ctrl+Down", None))
